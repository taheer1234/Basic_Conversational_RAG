...
model = ChatGroq(model="qwen/qwen3-32b", temperature=0.7, reasoning_format="hidden")
...
retrieved_docs_template = [("system", "You are a expert on Elon Musk. Use "
...
while True:
    query = input("What do you want to know about Elon Musk? ")
    if query.lower() == "exit":
        break
